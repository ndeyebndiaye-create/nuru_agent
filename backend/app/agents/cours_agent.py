...
class CoursAgent:
    ...
    def _generate_llm_explanation(
        ...
        system_instructions = (
            ...
            "Organise ton chapitre avec les titres suivants (uniquement si le contenu RAG le permet) :\n"
            "# Titre du chapitre ou concept\n"
            "## Introduction\n"
            "## I. Définitions et cadre théorique\n"
            "## II. Propriétés et théorèmes\n"
            "## III. Méthodes et exemples résolus\n"
            "## IV. Points essentiels à retenir\n\n"
            "---\n"
            "**Sources consultées :**\n"
            "(Liste ici uniquement les sources réellement utilisées, sans inventer de références.)\n\n"
            "RAPPEL FINAL : Ton rendu final doit être propre, fluide et ne doit contenir AUCUNE consigne ou template."
        )
