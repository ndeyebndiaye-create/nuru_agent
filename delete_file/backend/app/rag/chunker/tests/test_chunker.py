...
"""
Script de démonstration du chunker pédagogique.
Exécutez-le pour voir les résultats en sortie.
"""
import sys
...
def demo_chunker():
    """Démonstration du chunker avec un exemple."""
    
    print("\n" + "=" * 80)
    print("🧪 CHUNKER PÉDAGOGIQUE - DÉMONSTRATION")
    print("=" * 80)
...
"""
    ...
    print(f"   Taille idéale: {config.ideal_chunk_size}")
    ...
    for i, chunk in enumerate(chunks, 1):
        ...
        print(f"    FORMULES: {chunk.get('metadata', {}).get('formula_count', 0)}")
